...
SING_BOX_PATH='/SagerNet/sing-box/releases/download/v1.13.0-alpha.14'
...
SING_BOX_CONFIG_TEMPLATES_URL="https://github.com/469138946ba5fa/make-sing-box-envs/raw/refs/heads/master/1.13.0-alpha.14.json"
SING_BOX_CONFIG_TEMPLATES_FILE=${SING_BOX_DIR_PATH}'/1.13.0-alpha.14.json'
